    ...
    <div className="rounded-3xl border border-white/10 bg-zinc-950/70 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
      <div className="flex flex-col gap-6 lg:flex-row">
        <div className="lg:w-1/3">
          ...
          <h2 className="mt-2 text-2xl font-semibold text-white">Update your student profile</h2>
          <p className="mt-3 text-sm text-zinc-400">This section is frontend-only and ready for API integration later.</p>
        ...
        <div className="flex-1 space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <label className="text-sm text-zinc-300">
              ...
              <input defaultValue={profile.college} className="w-full rounded-2xl border border-white/10 bg-zinc-900/80 px-3 py-2 outline-none" />
            </label>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <label className="text-sm text-zinc-300">
              ...
              <input defaultValue={profile.branch} className="w-full rounded-2xl border border-white/10 bg-zinc-900/80 px-3 py-2 outline-none" />
            </label>
            <label className="text-sm text-zinc-300">
              <span className="mb-2 block">Year</span>
              <input defaultValue={profile.year} className="w-full rounded-2xl border border-white/10 bg-zinc-900/80 px-3 py-2 outline-none" />
            </label>
          </div>
